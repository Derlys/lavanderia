...
import { WebUtilSdkService, LoginInput, RegisterInput, User } from '@lavanderia/web/util/sdk'
...
export class WebAuthStore extends ComponentStore<WebAuthDataAccessState> {
  ...
  constructor(public readonly data: WebUtilSdkService, private readonly router: Router) {
    super()
