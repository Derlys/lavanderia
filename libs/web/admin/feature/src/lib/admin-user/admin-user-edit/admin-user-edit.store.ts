...
import { AdminUpdateUserInput, WebUtilSdkService, User } from '@lavanderia/web/util/sdk'
...
export class AdminUserEditStore extends ComponentStore<UserEditState> {
  constructor(private readonly data: WebUtilSdkService, route: ActivatedRoute) {
    super({ loading: false })
