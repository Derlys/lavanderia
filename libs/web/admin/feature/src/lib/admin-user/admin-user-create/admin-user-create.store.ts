...
import { AdminCreateUserInput, WebUtilSdkService, User } from '@lavanderia/web/util/sdk'
...
export class AdminUserCreateStore extends ComponentStore<UserCreateState> {
  constructor(private readonly data: WebUtilSdkService, private readonly router: Router) {
    super({ loading: false })
  }
